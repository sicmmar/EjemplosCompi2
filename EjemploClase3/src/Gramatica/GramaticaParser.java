...
public class GramaticaParser extends Parser {
	...
	public static final int
		...
		T__17=18, INTR=19, STRINGR=20, BOOLR=21, IMPRIMIR=22, SUBR=23, ENDR=24, 
		INTENT=25, IN=26, INT=27, IDEN=28, STRING=29, WS=30;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'('", "')'", "'\\n'", "'implicit'", "'none'", "','", "':'", "'call'", 
			"'{'", "'}'", "'='", "'*'", "'/'", "'+'", "'-'", "'.'", "'true'", "'false'", 
			"'int'", "'string'", "'bool'", "'imprimir'", "'subroutine'", "'end'", 
			"'intent'", "'in'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, "INTR", "STRINGR", "BOOLR", 
