...
public class GramaticaParser extends Parser {
	...
	public final LinstruccionesContext linstrucciones() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__7) | (1L << T__8) | (1L << INTR) | (1L << STRINGR) | (1L << BOOLR) | (1L << IMPRIMIR) | (1L << SUBR))) != 0)) {
				{
				{
				setState(29);
				instrucciones();
	...
	public static class TypeContext extends ParserRuleContext {
		...
		public TerminalNode BOOLR() { return getToken(GramaticaParser.BOOLR, 0); }
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			setState(107);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << INTR) | (1L << STRINGR) | (1L << BOOLR))) != 0)) ) {
